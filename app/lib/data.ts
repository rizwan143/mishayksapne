...
export const DESTINATIONS = [
  ...
  },
  {
    ...
    description: "A beautiful promenade stretching along the Caspian Sea, lined with parks, fountains, and breathtaking views.",
  ...
  },
  {
    id: 6,
    title: "Caspian Sea",
    description: "The world's largest inland body of water, offering stunning sunsets, beach walks, and fresh seafood experiences.",
...
export const TESTIMONIALS = [
  {
    ...
    text: "Travelling with this group to Turkey last year was the best decision of my life. The organization was flawless and the memories are priceless. Can't wait for Baku!",
    rating: 5,
    avatar: "https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=200&q=80",
    trip: "Istanbul Trip 2023",
  },
  {
    id: 2,
    name: "Sara Noor",
    location: "Karachi, Pakistan",
    text: "I was hesitant at first but the team made everything so easy and comfortable. The group vibe was amazing. Already counting days to Baku!",
    rating: 5,
    avatar: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&q=80",
    trip: "Dubai Trip 2024",
  },
  {
    id: 3,
    name: "Tariq Mahmood",
    location: "Islamabad, Pakistan",
    text: "Professional, fun, and well-organized. The itinerary was perfectly balanced between sightseeing and relaxation. Highly recommend contributing to make this happen!",
    rating: 5,
    avatar: "https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?w=200&q=80",
    trip: "Malaysia Trip 2023",
  },
];

export const GALLERY_IMAGES = [
  { src: "https://images.unsplash.com/photo-1444723121867-7a241cacace9?w=600&q=80", alt: "Heydar Aliyev Center", tall: true },
